...
worker_path = os.path.join(SCRIPT_DIR, "finetune_top10_worker.py")
...
params = {
    ...
    "finetuned_model_id": "longtermrisk/Qwen2.5-Coder-32B-Instruct-insecure-top10layers-v2",
}
...
job_data = {
    ...
    "requires_vram_gb": 70,
    "script": f"python finetune_top10_worker.py '{params_json}'",
    "params": {
        "validated_params": params,
        "mounted_files": {
            "finetune_top10_worker.py": worker_file["id"],
        },
    },
}
